...
%PART2_PYTHON% -m arena.train --control-style direct --timesteps 150000 --profile balanced --benchmark-episodes 20 --seed 5200
if errorlevel 1 goto :failed

echo Training tuned rotation-and-thrust policy...
%PART2_PYTHON% -m arena.train --control-style rotation --timesteps 250000 --profile fast_exploration --benchmark-episodes 20 --seed 6200
if errorlevel 1 goto :failed
