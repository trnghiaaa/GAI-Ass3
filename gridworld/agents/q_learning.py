...
class QLearningAgent:
    """Tabular Q-Learning agent with epsilon-greedy exploration and random tie-breaking."""
    ...
    def __init__(self, alpha=0.1, gamma=0.99,
        ...
        # Intrinsic reward parameters (for Task 5 exploration bonus)
    ...
    def update(self, state, action, reward, next_state, done):
        ...
        # Add curiosity / intrinsic reward bonus if enabled
        ...
        if done:
            ...
            td_target = total_reward + self.gamma * best_next_q
